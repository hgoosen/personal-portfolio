...
import HenriPhoto from './images/henri.png'
...
function TitleCard() {
  return (
    <div className="px-4 relative bg-cover bg-fixed h-screen w-full  flex flex-col items-center justify-center bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.5)),url(./images/web-background.jpg)]">
      <h1 className="font-title text-8xl! text-white text-center mb-6">Henri Goosen</h1>
      <Image src={HenriPhoto} alt="" height={700} width={400} className='absolute top-1/6 ml-350 mt-2.5'/>
